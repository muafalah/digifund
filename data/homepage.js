...
export const ourDiffFeatures = [
  {
    ...
    title: "Data Driven",
    des: "We provide capital that is unbiased, flexible and non dilutive with the execution support to accelerate value creation.",
  },
  {
...
export const testimonialsData = [
  ...
  {
    comment:
      "I have been working with DIGIFUND on our fundraising strategies. They understands the in depth strategies of Venture Capital and early stage fund raising/company",
    name: "Cheryl R. Weiss",
